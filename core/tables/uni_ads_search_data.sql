...
--
-- Объявления на поиск товаров (поиск предложений)
--
CREATE TABLE `uni_ads_search_data` (
  `id` int NOT NULL,
...
--
-- Индексы таблицы `uni_ads_search_data`
--
ALTER TABLE `uni_ads_search_data`
  ADD PRIMARY KEY (`id`),
...
--
-- AUTO_INCREMENT для таблицы `uni_ads_search_data`
--
ALTER TABLE `uni_ads_search_data`
