...
{   
    ...
    $data->ads_search = $this->component->profile->getAllAdsSearchUser($this->user->data->id);
    $data->show_ads_search_block = $data->ads_search !== '';
...
{   
    ...
    $data->ads_search = $this->component->profile->getHomeAdsSearchUser($this->user->data->id);
    $data->show_ads_search_block = $data->ads_search !== '';
...
{   
    ...
    $data->ads_search = $this->component->profile->getHomeAdsSearchUserPublicActive($data->user->id);
    $data->show_user_ads_search = $data->ads_search !== '';
