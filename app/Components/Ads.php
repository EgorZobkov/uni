 ...
 * — Итог: [язык/] {geo.alias}/ {chain}/ {alias}-{id}  или  [язык/] {chain}/ {alias}-{id}
 * Маршрут: GET /:all/:string-:int → AdCardController@card (первый параметр — все сегменты до последнего).
 */
...
public function outHrefAdsSearchCatalog(){
    // Путь совпадает с routes/web.php GET /ad/search (именованный маршрут ads-search-catalog).
    return outLink('ad/search');
}
