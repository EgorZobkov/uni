...
$this->container->router->get('/search', 'HomeController@search', ['name' => 'global-search', 'before' => ['WebTranslateMiddleware', 'WebMiddleware']]);
...
$this->container->router->get('/ad/search/create/', 'AdSearchController@create', ['name' => 'ad-search-create', 'before' => ['WebTranslateMiddleware', 'WebMiddleware', 'VerificationAuthMiddleware']]);
$this->container->router->get('/ad/search/edit/:int', 'AdSearchController@edit', ['name' => 'ad-search-edit', 'before' => ['WebTranslateMiddleware', 'WebMiddleware', 'VerificationAuthMiddleware']]);
$this->container->router->xpost('/ad/search/create/publication', 'AdSearchController@publication', ['name' => 'ad-search-publication', 'before' => ['WebTranslateMiddleware', 'PostMiddleware', 'VerifyCsrfTokenMiddleware']]);
$this->container->router->xpost('/ad/search/update', 'AdSearchController@update', ['name' => 'ad-search-update', 'before' => ['WebTranslateMiddleware', 'PostMiddleware', 'VerificationAuthMiddleware', 'VerifyCsrfTokenMiddleware']]);
$this->container->router->get('/s', 'AdSearchController@catalog', ['name' => 'ads-search-catalog', 'before' => ['WebTranslateMiddleware', 'WebMiddleware']]);
$this->container->router->xpost('/ad/search/load-items', 'AdSearchController@loadCatalogItems', ['name' => 'ad-search-load-items', 'before' => ['WebTranslateMiddleware', 'PostMiddleware', 'VerifyCsrfTokenMiddleware']]);
...
$this->container->router->xpost('/ad-search/card/show-contacts', 'AdSearchController@showContacts', ['name' => 'ad-search-card-show-contacts', 'before' => ['WebTranslateMiddleware', 'PostMiddleware', 'VerifyCsrfTokenMiddleware']]);
$this->container->router->xpost('/ad-search/card/status-publication', 'AdSearchController@changeCardStatusPublication', ['name' => 'ad-search-card-status-publication', 'before' => ['WebTranslateMiddleware', 'PostMiddleware', 'VerificationAuthMiddleware', 'VerifyCsrfTokenMiddleware']]);
...
if($this->container->settings->multi_languages_status){
	...
	if($languages){
		foreach ($languages as $value) {
			...
			$this->container->router->get('/'.$value["iso"].'/search', 'HomeController@search', ['before' => ['WebTranslateMiddleware', 'WebMiddleware']]);
			$this->container->router->get('/'.$value["iso"].'/s', 'AdSearchController@catalog', ['before' => ['WebTranslateMiddleware', 'WebMiddleware']]);
			$this->container->router->get('/'.$value["iso"].'/i', 'CatalogController@catalog', ['before' => ['WebTranslateMiddleware', 'WebMiddleware']]);
			$this->container->router->get('/'.$value["iso"].'/i/:all/:string-:int', 'AdCardController@card', ['before' => ['WebTranslateMiddleware', 'WebMiddleware']]);
			$this->container->router->get('/'.$value["iso"].'/i/:all', 'CatalogController@catalog', ['before' => ['WebTranslateMiddleware', 'WebMiddleware']]);
		}
	}
...
$this->container->router->get('/i', 'CatalogController@catalog', ['before' => ['WebTranslateMiddleware', 'WebMiddleware']]);
$this->container->router->get('/i/:all/:string-:int', 'AdCardController@card', ['name' => 'ad-card', 'before' => ['WebTranslateMiddleware', 'WebMiddleware']]);
$this->container->router->get('/i/:all', 'CatalogController@catalog', ['name' => 'catalog', 'before' => ['WebTranslateMiddleware', 'WebMiddleware']]);