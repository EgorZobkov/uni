...
$data = $app->model->ads_search_data->pagination(true)->page($_POST['page'])->output($_POST['output'])->search($_POST['search'])->filter($_POST['filter'])->sort('id desc')->getAll();
        ...
        ?>
              ...
              <tr>
                ...
                <td>
                  <div class="d-flex justify-content-left align-items-center">
                    <div class="avatar-wrapper">
                      <div class="avatar me-3"><img src="<?php echo $value->media->images->first_m ?? $value->media->images->first ?? $app->storage->name('no-image.png')->get(); ?>" class="image-autofocus rounded"></div>
                    </div>
                    <div class="d-flex flex-column">
                      <div class="fw-medium cursor-pointer color-link loadAdSearchCard" data-ad-id="<?php echo $value->id; ?>"><?php echo trimStr($value->title, 40, true); ?></div>
                ...
                <div class="flex-column flex-md-row align-items-center text-end">
                  ...
                  <button type="button" class="btn btn-icon btn-sm btn-label-primary waves-effect waves-light loadAdSearchCard" data-ad-id="<?php echo $value->id; ?>">
                    <i class="ti ti-xs ti-pencil"></i>
                  </button>

                  <button type="button" class="btn btn-icon btn-sm btn-label-danger waves-effect waves-light deleteAdSearch" data-id="<?php echo $value->id; ?>">
