      ...
      <?php
        ...
        foreach ($data as $value) {
            ...
            <tr>
              <td>
                <?php if($ad){ ?>
                   <div class="container-mini-card-image" > <a href="<?php echo $app->component->ads->buildAliasesAdCard($ad); ?>" target="_blank" ><img src="<?php echo $ad->media->images->first_m ?: $ad->media->images->first; ?>" class="image-autofocus" ></a> </div>
                <?php }else{ ?>
