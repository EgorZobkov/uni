<div class="col-12 h-100" >
    <a class="container-item-list mf-card mf-card-product mf-card-product--horizontal <?php if($value->service_highlight_status){ echo 'container-item-list-highlight'; } ?>" href="<?php echo $app->component->ads->buildAliasesAdCard($value); ?>" >
    ...
    <div class="row" >
      ...
      <div class="col-md-7 col-lg-7 col-sm-7 col-12" >
        ...
        <div class="container-item-list-content mf-card-product__body" >
           <div class="container-item-list-content-title mf-card-product__title" ><?php echo trimStr($value->title, 100, true); ?></div>
           ...
           <?php } ?>
           <div class="container-item-list-content-prices mf-card-product__price" ><?php echo $app->component->ads->outPrices($value); ?></div>
           ...
           <?php } ?>       
           <div class="container-item-list-content-additionally mf-card-product__meta" >
