      ...
      <div class="col-md-9 col-sm-9 col-lg-9 col-7" >
        ...
        <div class="profile-container-item-list-content mf-card-product__body" >
          <div class="profile-container-item-list-content-status" ><?php echo $app->component->ads->outStatusByAd($value->status); ?></div>
           <div class="profile-container-item-list-content-title mf-card-product__title" ><?php echo $value->title; ?></div>
           <div class="profile-container-item-list-content-prices mf-card-product__price" ><?php echo $app->component->ads->outPrices($value); ?></div>
