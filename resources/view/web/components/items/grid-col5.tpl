<div class="col h-100" >
 <a class="container-item-grid mf-card mf-card-product <?php if($value->service_highlight_status){ echo 'container-item-grid-highlight'; } ?>" href="<?php echo $app->component->ads->buildAliasesAdCard($value); ?>" <?php if($app->settings->board_catalog_ad_option_opening == "blank"){ echo 'target="_blank" rel="noopener"'; } ?> >
