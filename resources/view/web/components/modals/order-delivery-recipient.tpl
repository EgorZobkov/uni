<h3 class="modal-title mf-modal__title" > <strong><?php echo translate("tr_e3956f167dd00ecf8648f41119bd5a3e"); ?></strong> </h3>

<form class="order-buy-delivery-recipient-form mf-form ds-stack-16" >

      <div class="row" >

        <div class="col-lg-12 mf-form-group" >
	  ...
	  <div class="mf-modal__actions mf-modal__actions--end">
		  <button class="btn-custom mf-btn mf-btn-md mf-btn-primary actionSaveDeliveryRecipient"><?php echo translate("tr_74ea58b6a801f0dce4e5d34dbca034dc"); ?></button>
	  </div>
