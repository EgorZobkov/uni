...
<div class="text-end mt30">
	<button class="btn-custom button-color-scheme5 actionCancelOrderDeal" data-id="<?php echo $data->order_id; ?>" ><?php echo translate("tr_ecdbdc8b4c68acdb3b84d57d23d884f9"); ?></button>
</div>