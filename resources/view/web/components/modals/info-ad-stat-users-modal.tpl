...
<h3 class="modal-title mf-modal__title" > <strong><?php echo translate("tr_6a904d70a0d502e05b5de3b4170738fe"); ?></strong> </h3>
<?php }elseif($data->view == "favorite"){ ?>
<h3 class="modal-title mf-modal__title" > <strong><?php echo translate("tr_039655cd90b7a55151dfed2054b24fed"); ?></strong> </h3>
<?php }elseif($data->view == "contacts"){ ?>
<h3 class="modal-title mf-modal__title" > <strong><?php echo translate("tr_cc7158dce083ce9fa040443223868d51"); ?></strong> </h3>
<?php } ?>
