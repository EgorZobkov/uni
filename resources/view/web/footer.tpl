...
<div class="main-floating-menu d-flex d-lg-none" >
    ...
    <a href="#" class="actionOpenMobileFloatingAddMenu">
        <div>
...
<div class="main-floating-add-overlay d-lg-none" aria-hidden="true">
    <div class="main-floating-add-backdrop actionCloseMobileFloatingAddMenu" role="presentation"></div>
    <div class="main-floating-add-sheet">
        <a href="{{ outRoute('ad-create') }}" class="main-floating-add-sheet-item">{{ translate("tr_header_add_type_sale") }}</a>
        <a href="{{ outRoute('ad-search-create') }}" class="main-floating-add-sheet-item">{{ translate("tr_header_add_type_search") }}</a>
    </div>
</div>
