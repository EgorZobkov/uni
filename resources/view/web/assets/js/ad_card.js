...
$(document).ready(function () {
   ...
   $(document).on('click','.actionAdSearchShowContacts', function (e) {  
      
      helpers.startProcessLoadButton($('.actionAdSearchShowContacts'));

      helpers.request({url:"ad-search-card-show-contacts", data: {id:$(this).data("id")}, precheck: true, button: $('.actionAdSearchShowContacts')}, function(data) {

         $("#contactModal .contact-container").html(data["content"]);
         helpers.openModal("contactModal");
         helpers.endProcessLoadButton($('.actionAdSearchShowContacts'));
   ...
   $(document).on('click','.actionAdSearchRemovePublication', function (e) {

      helpers.startProcessLoadButton($('.actionAdSearchRemovePublication'));

      helpers.request({url:"ad-card-status-publication", data: {id:$(this).data("id"), is_ads_search: 1, reason: ($(this).data("reason") || '')}, precheck: true, button: $('.actionAdSearchRemovePublication')}, function(data) {
