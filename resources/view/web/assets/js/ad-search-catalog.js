  ...
  function loadItems(page = 1, button, scroll = false) {
    ...
    var showLoadError = function () {
      var errorHtml = '<div class="catalog-load-error text-center py-5">' +
        ...
        '<button type="button" class="btn-custom button-color-scheme1 actionRetryAdSearchLoadItems">' + (helpers.translate && helpers.translate.content ? helpers.translate.content('tr_catalog_load_retry') : 'Попробовать снова') + '</button>' +
        '</div>';
