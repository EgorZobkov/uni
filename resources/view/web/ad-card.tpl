...
<meta property="og:url" content="{{ $template->component->ads->buildAliasesAdSearchCard($data) }}">
{% else: %}
...
<div class="container mt20 mb40" >
    ...
    <nav aria-label="breadcrumb" class="mb15" >
      ...
      <ol class="breadcrumb" itemscope="" itemtype="http://schema.org/BreadcrumbList">
        ...
        {% if(!empty($data->is_ads_search)): %}
        {{ $template->component->ads->outBreadcrumbAdSearch(); }}
        {% else: %}
    ...
    {% if($data->owner && empty($data->is_ads_search)): %}
    ...
    <div class="row" >
      ...
      <div class="col-md-3 text-end" >
        ...
        <div class="ad-card-menu-line" >
          <span class="ad-card-menu-line-item active-scale actionOpenStaticModal" data-modal-target="adShare" data-modal-params="{{ $template->component->ads->buildAdShareModalParams($data) }}" ><i class="ti ti-share-3"></i></span>
        </div>
        {% else: %}
        <div class="ad-card-menu-line" >
